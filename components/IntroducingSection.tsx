...
const IntroducingSection = () => {
  return (
    <div
      className="py-20 pt-24 bg-gradient-to-l from-white to-blue-600"
      data-testid="introducing-section-container"
    >
      <div
        className="text-center flex flex-col gap-y-5 items-center"
        data-testid="introducing-content-container"
      >
        <h2
          className="text-white text-8xl font-extrabold text-center mb-2 max-md:text-6xl max-[480px]:text-4xl"
          data-testid="introducing-title"
        >
          INTRODUCING <span className="text-black">SINGI</span>
          <span className="text-blue-600">TRONIC</span>
        </h2>
        <div data-testid="introducing-text-container">
          <p
            className="text-white text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base"
            data-testid="introducing-subtitle-1"
          >
            Buy the latest electronics.
          </p>
          <p
            className="text-white text-center text-2xl font-semibold max-md:text-xl max-[480px]:text-base"
            data-testid="introducing-subtitle-2"
          >
          ...
          <Link
            ...
            data-testid="introducing-shop-now-link"
          >
            SHOP NOW
          </Link>
        </div>
