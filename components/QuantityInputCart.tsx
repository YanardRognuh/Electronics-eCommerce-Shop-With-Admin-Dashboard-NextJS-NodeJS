...
const QuantityInputCart = ({ product }: { product: ProductInCart }) => {
  ...
  return (
    <div data-testid="quantity-input-cart-container">
      ...
      <div
        className="flex items-center justify-center rounded border border-gray-200 w-32"
      ...
      >
        ...
        >
          <FaMinus data-testid="minus-icon" />
        </button>
